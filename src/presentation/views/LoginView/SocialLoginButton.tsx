 ...
 * Matches the dark #111 surface style used by inputs so all interactive
 * elements on the login card share the same visual language.
 */
...
function ProviderIcon({ strategy }: { strategy: string }) {
  switch (strategy) {
    ...
    case 'github':
      return (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="#f1f5f9" style={{ flexShrink: 0 }} aria-hidden="true">
    ...
    default:
      return (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0 }} aria-hidden="true">
          <circle cx="12" cy="12" r="10" stroke="#c97040" strokeWidth="2" />
          <path d="M8 12h8M12 8l4 4-4 4" stroke="#c97040" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      );
  }
}
