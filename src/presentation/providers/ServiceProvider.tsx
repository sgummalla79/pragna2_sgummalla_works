...
import { PragnaFlowsRepository } from '@/infrastructure/repositories/PragnaFlowsRepository';
...
import { PragnaFlowsService } from '@/application/services/PragnaFlowsService';
...
export function ServiceProvider({ children }: ServiceProviderProps) {
  ...
  const services = useMemo(() => {
    ...
    const pragnaFlowsRepo    = new PragnaFlowsRepository(axiosClient);
    ...
    return {
      ...
      pragnaFlowsService:  new PragnaFlowsService(pragnaFlowsRepo),
